...
class Section:
    ...
    def __init__(self, head: Union[SectionHead, DefaultSectionHead]):
        self._head = head
    ...
    def replace(self, replacement: Section) -> None:
        ...
        if self.head.prev is None:
            ...
            self.head.prev.next = section.head
            section.head.prev = self.head.prev
        ...
        if tail.next is None:
            ...
            tail.next.prev = replacement_tail
            replacement_tail.next = tail.next
        self.head.prev = tail.next = None
