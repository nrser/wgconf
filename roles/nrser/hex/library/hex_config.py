...
# SEE   https://hexdocs.pm/hex/Mix.Tasks.Hex.Config.html#module-config-keys
# 
# key                       type    default
# -----------------------------------------
# api_key:                  str     nil
...
# http_proxy:               str     nil
# http_timeout:             int     nil     # NOTE Doesn't work for `deps.get`!
# https_proxy:              str     nil
# mirror_url:               str     nil
# no_verify_repo_origin:    bool    false
# offline:                  bool    false
# repos_key:                ?       nil     # NOTE Undocumented
